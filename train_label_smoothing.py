...
smooth = 0.9
target_real = Variable(Tensor(opt.batchSize).fill_(smooth), requires_grad=False)
target_fake = Variable(Tensor(opt.batchSize).fill_(1-smooth), requires_grad=False)
