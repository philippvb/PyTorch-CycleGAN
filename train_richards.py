...
optimizer_G = torch.optim.SGD(itertools.chain(netG_A2B.parameters(), netG_B2A.parameters()),
                                lr=opt.lr, momentum=0)
optimizer_D_A = torch.optim.SGD(netD_A.parameters(), lr=opt.lr, momentum=0)
optimizer_D_B = torch.optim.SGD(netD_B.parameters(), lr=opt.lr, momentum=0)
